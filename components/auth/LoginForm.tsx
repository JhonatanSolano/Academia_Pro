...
/**
 * LoginForm — the visual login card content, extracted from page.tsx.
 * Can be used standalone (login page) or inside a modal (landing).
 */
export default function LoginForm() {
  ...
  return (
    <motion.div
      ...
      className="flex w-full max-w-sm flex-col items-center gap-8 rounded-3xl border border-white/10 bg-white/5 p-10 backdrop-blur-xl"
    >
      {/* Logo */}
      <div className="flex flex-col items-center gap-3">
        ...
        <h2 className="text-xl font-bold text-text-inverse">Pódium Académico</h2>
      ...
      <p className="text-center text-xs text-slate-300">
        ...
        <a href="#" className=" text-white text-brand hover:underline">
          Términos de uso
        </a>{" "}
        y{" "}
        <a href="#" className=" text-white text-brand hover:underline">
